...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="hidden" class="input-text upload-url" id="cover_img" name="cover_img" value="">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="hidden" class="input-text upload-url" id="video_address" name="video_address" value="">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="" name="teacher_name" id="teacher_name">
		</div>
	</div>
	<div class="row cl">
